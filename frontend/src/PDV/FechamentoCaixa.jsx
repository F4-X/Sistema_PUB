...
export default function FechamentoCaixa() {
  ...
  const [dinheiroDecl, setDinheiroDecl] =
    useState("");

  const [pixDecl, setPixDecl] =
    useState("");

  const [cartaoDecl, setCartaoDecl] =
    useState("");
